...
func TestScheduleCampaignPoint(t *testing.T) {
	...
	testsuite.QueueBatchTask(t, rt, testdb.Org1, &tasks.ScheduleCampaignPoint{PointID: testdb.RemindersPoint1.ID})
	...
	testsuite.QueueBatchTask(t, rt, testdb.Org1, &tasks.ScheduleCampaignPoint{PointID: testdb.RemindersPoint2.ID})
	testsuite.FlushTasks(t, rt)
	...
	testsuite.QueueBatchTask(t, rt, testdb.Org1, &tasks.ScheduleCampaignPoint{PointID: event3.ID})
	testsuite.FlushTasks(t, rt)
	...
	testsuite.QueueBatchTask(t, rt, testdb.Org1, &tasks.ScheduleCampaignPoint{PointID: event4.ID})
	testsuite.FlushTasks(t, rt)
