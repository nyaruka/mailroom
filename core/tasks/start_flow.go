...
func init() {
	RegisterType(TypeStartFlow, func() Task { return &StartFlow{} })
}

// StartFlow is the start flow task
type StartFlow struct {
	*models.FlowStart
}

func (t *StartFlow) Type() string {
	return TypeStartFlow
}

// Timeout is the maximum amount of time the task can run for
func (t *StartFlow) Timeout() time.Duration {
	return time.Minute * 60
}

func (t *StartFlow) WithAssets() models.Refresh {
