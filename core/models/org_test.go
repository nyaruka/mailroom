...
func TestLoadOrg(t *testing.T) {
	...
	assert.Equal(t, 1000, org.Limit(models.LimitContacts))
	assert.Equal(t, models.NoLimit, org.Limit("groups")) // not set
	...
	assert.Equal(t, models.NoLimit, org.Limit(models.LimitContacts)) // no limits at all
