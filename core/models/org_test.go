...
func TestStoreAttachment(t *testing.T) {
	...
	assert.Equal(t, utils.Attachment("image/jpeg:http://localhost:4566/test-attachments/attachments/1/6683/83ba/668383ba-387c-49bc-b164-1213ac0ea7aa.jpg"), attachment)
