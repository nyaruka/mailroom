...
func TestSpecVersion(t *testing.T) {
	assert.Equal(t, semver.MustParse("14.5.0"), goflow.SpecVersion())
}
...
func TestMigrateDefinition(t *testing.T) {
	...
	versions := []string{"13.0.0", "13.1.0", "13.2.0", "13.3.0", "13.4.0", "13.5.0", "13.6.0", "13.6.1", "14.0.0", "14.1.0", "14.2.0", "14.3.0", "14.3.1", "14.4.0", "14.5.0"}
