...
func TestSyncAndroidChannels(t *testing.T) {
	...
	testChannel4 := testdb.InsertChannel(t, rt, testdb.Org1, "A", "Android 4", "567", []string{"tel"}, "SR", map[string]any{"FCM_ID": "FCMID4"}) // valid FCM ID
	testChannel5 := testdb.InsertChannel(t, rt, testdb.Org1, "A", "Android 5", "678", []string{"tel"}, "SR", map[string]any{"FCM_ID": "FCMID5"}) // valid FCM ID
