...
func TestSearch(t *testing.T) {
	...
	k1 := testdb.InsertKnowledgeSource(t, rt, testdb.Org1, "5384b1c6-1099-4a5f-a005-9d3a4092c5c1", models.KnowledgeSourceTypeShortcuts, "Test Shortcuts", models.KnowledgeSourceStatusReady)
	...
	k2 := testdb.InsertKnowledgeSource(t, rt, testdb.Org1, "78bee0eb-a3d1-4e2b-b91b-6ee1c2f1ab19", models.KnowledgeSourceTypeShortcuts, "Pending", models.KnowledgeSourceStatusPending)
	...
	k3 := testdb.InsertKnowledgeSource(t, rt, testdb.Org2, "df22cbcb-e0e1-4e78-be9f-2e4fbea1b2c3", models.KnowledgeSourceTypeShortcuts, "Other Org", models.KnowledgeSourceStatusReady)
	...
	k4 := testdb.InsertKnowledgeSource(t, rt, testdb.Org1, "c1f5d6a3-8e2b-4f7c-9a0d-3b6e1f2a4c5d", models.KnowledgeSourceTypeHelpdesk, "Test Helpdesk", models.KnowledgeSourceStatusReady)
	...
	results, err = knowledge.Search(ctx, rt, oa, "how do refunds work?", []models.KnowledgeSourceUUID{k1.UUID}, 10)
	require.NoError(t, err)
	require.Len(t, results, 3)
	for _, r := range results {
		assert.Equal(t, k1.UUID, r.SourceUUID)
	}

	// and searching only the second leaves out the first's
	results, err = knowledge.Search(ctx, rt, oa, "how do refunds work?", []models.KnowledgeSourceUUID{k4.UUID}, 10)
	require.NoError(t, err)
	...
	results, err = knowledge.Search(ctx, rt, oa, "how do refunds work?", []models.KnowledgeSourceUUID{k2.UUID, k3.UUID}, 10)
	require.NoError(t, err)
