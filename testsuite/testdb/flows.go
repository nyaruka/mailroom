...
func InsertFlowSession(rt *runtime.Runtime, contact *Contact, sessionType models.FlowType, status models.SessionStatus, currentFlow *Flow, callID models.CallID) flows.SessionUUID {
	...
	rt.DB.MustExec(
		`INSERT INTO flows_flowsession(uuid, contact_uuid, contact_id, status, output, created_on, session_type, current_flow_id, call_id, ended_on) 
		 VALUES($1, $2, $3, $4, '{}', NOW(), $5, $6, $7, $8) RETURNING id`, uuid, contact.UUID, contact.ID, status, sessionType, currentFlow.ID, callID, endedOn,
	)
	return uuid
}
...
func InsertWaitingSession(rt *runtime.Runtime, org *Org, contact *Contact, sessionType models.FlowType, currentFlow *Flow, callID models.CallID) flows.SessionUUID {
	...
	rt.DB.MustExec(
		`INSERT INTO flows_flowsession(uuid, contact_uuid, contact_id, status, last_sprint_uuid, output, created_on, session_type, current_flow_id, call_id) 
		 VALUES($1, $2, $3, 'W', $4, '{"status":"waiting"}', NOW(), $5, $6, $7) RETURNING id`, uuid, contact.UUID, contact.ID, uuids.NewV4(), sessionType, currentFlow.ID, callID,
	)
